          ...
          <Form noValidate validated={this.state.validated}>
            ...
            <Form.Group>
              ...
              <Form.Control required as='select' name='clubs' onChange={this.handleEventParam} value={this.state.clubs} multiple={true}>
                ...
                <option value='Barowsky Student Association'>Barowsky Student Association</option>
                <option value='Global Ambassadors'>Global Ambassadors</option>
